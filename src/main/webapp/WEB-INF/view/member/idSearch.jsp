...
%>
<link rel="stylesheet" href="./resources/member/css/idSearch.css">
			
			<!-- 아이디찾기 -->
                <div id="id_search">
                    <div hidden class="id_search1"></div>
                    <div class="id_search_sub">
                        <h2 class="id_search_name">아이디 찾기</h2>
                    </div>
                    <div class="certification">
                        ...
                        <form class="search" id="idSearchForm" method="post"
							  action="<%=contextPath%>/idSearch.do">
                            <div class="name_search">
                                <div class="name_search1">
                                    <label for="name" class="name">이름</label>
                                    <div class="name_search2">
                                        <input type="text" data-testid="input-box" id="user_name" name="user_name" value
                                            placeholder="이름을 입력해주세요" class="name1">
                                    </div>
                                </div>
                            </div>
                            <div id="toggle">
	                            ...
	                            <div class="email_search">
	                                <div class="phone_search1">
	                                    <label for="email" class="phone">이메일</label>
	                                    <div class="phone_search2">
                            ...
                            <div class="find_id">
                                <button class="find_id1" id="find_id1" type="button" radius="4" style="cursor:pointer">
                                    <span class="find_id2">Find ID</span>
                                </button>
                            </div>
                        </form>
                    </div>
