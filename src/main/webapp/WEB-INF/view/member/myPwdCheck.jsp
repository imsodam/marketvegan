...
<c:if test="${sessionScope.idKey eq null}">
	<meta http-equiv="Refresh" content="0;url=/marketvegan/template/template.jsp?DIRECTORY=member&CONTENT=login">
</c:if>
...
<div class="page_aticle mypage">
	...
	<jsp:include page="/WEB-INF/view/member/pwdCheck.jsp" flush="false" />
</div>
</c:if>
